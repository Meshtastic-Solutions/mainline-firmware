...
#define LORA_MOSI 10
#define LORA_CS 8
#define LORA_DIO1 14 // LR2021 DIO5 -> ESP32 IO14 (IRQ); also the LoRa sleep-wake pin

#define LR2021_SPI_NSS_PIN LORA_CS
#define LR2021_IRQ_PIN LORA_DIO1
#define LR2021_NRESET_PIN 12
#define LR2021_BUSY_PIN 13
#define LR2021_IRQ_DIO_NUM 5 // radio-side DIO number wired to LR2021_IRQ_PIN
// LR2021 DIO6 -> ESP32 IO7 (second IRQ line, unused)
